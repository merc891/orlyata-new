...
$teachers = array(
	array( 'Чернецов', 'Андрей', 'Викторович', 'vict.png' ),
	array( 'Карпман', 'Ирина', 'Рафаиловна', 'karp.png' ),
	array( 'Чернецова', 'Елена', 'Ивановна', 'elena.png' ),
	array( 'Климова', 'Марьяна', 'Геннадьевна', 'mar.png' ),
	array( 'Угольникова', 'Ольга', 'Александровна', 'olg.png' ),
	array( 'Моисеева', 'Мария', 'Андреевна', 'mash.png' ),
);
$rows     = array(

...
?></div></section><?php get_template_part( 'template-parts/sections/application-cta', null, array( 'form_id' => 'about-application', 'reveal' => true, 'submit_label' => __( 'Оставить заявку', 'orlyata' ), 'variant' => 'about' ) ); ?><?php get_template_part( 'template-parts/sections/achievements-table', null, array( 'reveal' => true, 'rows' => $rows, 'variant' => 'about' ) ); ?></div><?php get_template_part( 'template-parts/layout/footer' ); ?></div></main></div>
<?php
get_footer();
